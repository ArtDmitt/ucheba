...
#ifndef LABA13_ORDERED_ARRAY_SET_H
#define LABA13_ORDERED_ARRAY_SET_H
...
// возбуждает исплючение, если в множестве по адресу set нельзя вставить элемент
...
#endif //LABA13_ORDERED_ARRAY_SET_H
